...
bpy.ops.building.apply_preset(preset_key='ARTISAN_FISHER_T3')

setup_render()
render_view('fisher_t3_front.png', (0.0, -16.0, 4.0), (0.0, 0.0, 1.6), lens=40)
render_view('fisher_t3_door.png', (0.0, -9.0, 1.6), (0.0, -2.0, 1.4), lens=45)

...
def run_tests():
    ...
    assert m_count == 13, f"Expected 13 material slots, got {m_count}"
    ...
    for tier in ['TIER_1', 'TIER_2', 'TIER_3']:
        ...
        m_count = len(obj.data.materials)
        assert m_count == 13, f"Expected 13 material slots for {tier}, got {m_count}"
        ...
        print(f"  -> Material {tier}: verified 12 generic procedural shader slots successfully: {mat_names}")
